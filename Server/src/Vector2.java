...
*/
	...
	public float angle (Vector2 reference) {
		return (float) Math.toDegrees((float)Math.atan2(crs(reference), dot(reference)));
	}
...
*/
	...
	@Override
	public boolean isPerpendicular(Vector2 other) {
		// TODO Auto-generated method stub
		return false;
	}

	@Override
	public boolean isPerpendicular(Vector2 other, float epsilon) {
		// TODO Auto-generated method stub
		return false;
	}
}